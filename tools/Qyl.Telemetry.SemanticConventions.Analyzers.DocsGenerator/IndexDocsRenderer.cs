...
/// <summary>
///   Renders the slim <c>docs/Qyl.Telemetry.SemanticConventions.Analyzers.md</c> index
...
internal static class IndexDocsRenderer
{
    ...
    private static void WriteRelatedDocs(StringBuilder sb)
    {
        ...
        sb.AppendLine("- [`AnalyzerReleases.Shipped.md`](../src/Qyl.Telemetry.SemanticConventions.Analyzers/AnalyzerReleases.Shipped.md) — release-tracking manifest with `ClassName, [Documentation](url)` attribution per Microsoft NetAnalyzers convention.");
    }
