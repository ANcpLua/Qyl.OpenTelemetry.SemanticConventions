...
{
    public const string PackageName = "Qyl.OpenTelemetry.SemanticConventions.Analyzers";
    public const string ProjectRelativePath = "tools/Qyl.OpenTelemetry.SemanticConventions.Analyzers.DocsGenerator";
    public const string SolutionFileName = "Qyl.OpenTelemetry.SemanticConventions.slnx";
