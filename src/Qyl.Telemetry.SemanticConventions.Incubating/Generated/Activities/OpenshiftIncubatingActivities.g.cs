...
/// </summary>
public static class OpenshiftIncubatingActivityExtensions
{
    /// <summary>
    /// The name of the cluster quota.
    /// </summary>
    public static global::System.Diagnostics.Activity SetOpenshiftClusterquotaName(
        this global::System.Diagnostics.Activity activity,
        string value)
        => activity.SetTag("openshift.clusterquota.name", value);

    /// <summary>
    /// The UID of the cluster quota.
    /// </summary>
    public static global::System.Diagnostics.Activity SetOpenshiftClusterquotaUid(
        this global::System.Diagnostics.Activity activity,
        string value)
        => activity.SetTag("openshift.clusterquota.uid", value);
}
