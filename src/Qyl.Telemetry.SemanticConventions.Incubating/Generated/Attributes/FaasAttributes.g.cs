...
namespace Qyl.Telemetry.SemanticConventions.Incubating.Attributes.Faas;
...
public static class FaasAttributes
{
    ...
    public static class DocumentOperationValues
    {
        ...
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "delete", "edit", "insert" };
    ...
    public static class TriggerValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "datasource", "http", "other", "pubsub", "timer" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
