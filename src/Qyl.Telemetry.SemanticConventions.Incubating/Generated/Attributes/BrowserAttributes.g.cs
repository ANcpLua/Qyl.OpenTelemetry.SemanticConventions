...
public static class BrowserAttributes
{
    ...
    public static class WebVitalNameValues
    {
        ...
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "cls", "fcp", "fid", "inp", "lcp", "ttfb" };
    ...
    public static class WebVitalNavigationTypeValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "back-forward", "back-forward-cache", "navigate", "prerender", "reload", "restore" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
