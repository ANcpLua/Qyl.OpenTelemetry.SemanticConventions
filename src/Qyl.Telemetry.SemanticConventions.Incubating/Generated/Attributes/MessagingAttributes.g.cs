...
namespace Qyl.Telemetry.SemanticConventions.Incubating.Attributes.Messaging;
...
public static class MessagingAttributes
{
    ...
    /// </remarks>
    public const string KafkaClusterId = "messaging.kafka.cluster.id";
    ...
    /// </remarks>
    public const string MasstransitBeginState = "messaging.masstransit.begin_state";
    ...
    /// </remarks>
    public const string MasstransitConsumerType = "messaging.masstransit.consumer_type";
    ...
    /// </remarks>
    public const string MasstransitCorrelationId = "messaging.masstransit.correlation_id";
    ...
    /// </remarks>
    public const string MasstransitDestinationAddress = "messaging.masstransit.destination_address";
    ...
    /// </remarks>
    public const string MasstransitEndState = "messaging.masstransit.end_state";
    ...
    /// </remarks>
    public const string MasstransitInitiatorId = "messaging.masstransit.initiator_id";
    ...
    /// </remarks>
    public const string MasstransitInputAddress = "messaging.masstransit.input_address";
    ...
    /// </remarks>
    public const string MasstransitMessageId = "messaging.masstransit.message_id";
    ...
    /// </remarks>
    public const string MasstransitMessageTypes = "messaging.masstransit.message_types";
    ...
    /// </remarks>
    public const string MasstransitRequestId = "messaging.masstransit.request_id";
    ...
    /// </remarks>
    public const string MasstransitSagaId = "messaging.masstransit.saga_id";
    ...
    /// </remarks>
    public const string MasstransitSourceAddress = "messaging.masstransit.source_address";
    ...
    /// </remarks>
    public const string MasstransitTrackingNumber = "messaging.masstransit.tracking_number";
    ...
    public static class OperationTypeValues
    {
        ...
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "create", "deliver", "process", "publish", "receive", "send", "settle" };
    ...
    /// </remarks>
    public const string RabbitmqDeliveryTag = "messaging.rabbitmq.delivery_tag";
    ...
    public static class RocketmqConsumptionModelValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "broadcasting", "clustering" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
    ...
    public static class RocketmqMessageTypeValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "delay", "fifo", "normal", "transaction" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
    ...
    public static class ServicebusDispositionStatusValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "abandon", "complete", "dead_letter", "defer" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
    ...
    public static class SystemValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "activemq", "aws.sns", "aws_sqs", "eventgrid", "eventhubs", "gcp_pubsub", "jms", "kafka", "pulsar", "rabbitmq", "rocketmq", "servicebus" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
}
