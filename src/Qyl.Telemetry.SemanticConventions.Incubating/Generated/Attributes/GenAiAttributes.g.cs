...
public static class GenAiAttributes
{
    ...
    public static class OperationNameValues
    {
        ...
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "chat", "create_agent", "create_memory", "create_memory_store", "delete_memory", "delete_memory_store", "embeddings", "execute_tool", "fetch_response", "generate_content", "invoke_agent", "invoke_workflow", "plan", "retrieval", "search_memory", "text_completion", "update_memory", "upsert_memory" };
    ...
    public static class OutputTypeValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "image", "json", "speech", "text" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
    ...
    public static class ProviderNameValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "anthropic", "aws.bedrock", "azure.ai.inference", "azure.ai.openai", "cohere", "deepseek", "gcp.gemini", "gcp.gen_ai", "gcp.vertex_ai", "groq", "ibm.watsonx.ai", "mistral_ai", "moonshot_ai", "openai", "perplexity", "x_ai" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
    ...
    public static class ResponseStatusValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "cancelled", "completed", "failed", "in_progress", "incomplete", "queued" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
    ...
    /// </remarks>
    public const string UsageAudioCacheReadInputTokens = "gen_ai.usage.audio.cache_read.input_tokens";
    ...
    /// </remarks>
    public const string UsageAudioInputTokens = "gen_ai.usage.audio.input_tokens";
    ...
    /// </remarks>
    public const string UsageAudioOutputTokens = "gen_ai.usage.audio.output_tokens";
    ...
    /// The value SHOULD be included in <c>gen_ai.usage.input_tokens</c>.
    /// </remarks>
    public const string UsageCacheWriteInputTokens = "gen_ai.usage.cache_write.input_tokens";
    ...
    /// </remarks>
    public const string UsageImageCacheReadInputTokens = "gen_ai.usage.image.cache_read.input_tokens";
    ...
    /// The value SHOULD be included in <c>gen_ai.usage.input_tokens</c>.
    /// </remarks>
    public const string UsageImageInputTokens = "gen_ai.usage.image.input_tokens";
    ...
    /// The value SHOULD be included in <c>gen_ai.usage.output_tokens</c>.
    /// </remarks>
    public const string UsageImageOutputTokens = "gen_ai.usage.image.output_tokens";
    ...
    /// </remarks>
    public const string UsageTextCacheReadInputTokens = "gen_ai.usage.text.cache_read.input_tokens";
    ...
    /// The value SHOULD be included in <c>gen_ai.usage.input_tokens</c>.
    /// </remarks>
    public const string UsageTextInputTokens = "gen_ai.usage.text.input_tokens";
    ...
    /// The value SHOULD be included in <c>gen_ai.usage.output_tokens</c>.
    /// </remarks>
    public const string UsageTextOutputTokens = "gen_ai.usage.text.output_tokens";
