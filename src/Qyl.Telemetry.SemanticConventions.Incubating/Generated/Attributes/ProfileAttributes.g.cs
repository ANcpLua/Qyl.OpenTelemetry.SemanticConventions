...
namespace Qyl.Telemetry.SemanticConventions.Incubating.Attributes.Profile;
...
public static class ProfileAttributes
{
    ...
    public static class FrameTypeValues
    {
        ...
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "beam", "cpython", "dotnet", "go", "jvm", "kernel", "luajit", "native", "perl", "php", "ruby", "rust", "v8js" };
