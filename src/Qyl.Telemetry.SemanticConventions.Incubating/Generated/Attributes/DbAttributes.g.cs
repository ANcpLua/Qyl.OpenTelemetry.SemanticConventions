...
public static class DbAttributes
{
    ...
    public static class CassandraConsistencyLevelValues
    {
        ...
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "all", "any", "each_quorum", "local_one", "local_quorum", "local_serial", "one", "quorum", "serial", "three", "two" };
    ...
    /// </remarks>
    public const string CommandName = "db.command.name";
    ...
    public static class CosmosdbOperationTypeValues
    {
        ...
        /// <summary>Every catalogued value, in the order the constants are declared.</summary>
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "batch", "create", "delete", "execute", "execute_javascript", "head", "head_feed", "invalid", "patch", "query", "query_plan", "read", "read_feed", "replace", "upsert" };
        /// <summary>Whether <paramref name="value"/> is a catalogued value (ordinal).</summary>
        public static bool Contains(string value) { foreach (var candidate in AllValues) if (string.Equals(candidate, value, global::System.StringComparison.Ordinal)) return true; return false; }
    }
    ...
    /// </remarks>
    public const string ElasticsearchSchemaUrl = "db.elasticsearch.schema_url";
    ...
    /// </remarks>
    public const string MongodbCursorId = "db.mongodb.cursor_id";
    ...
    /// </remarks>
    public const string MongodbDriverConnectionId = "db.mongodb.driver_connection_id";
    ...
    /// </remarks>
    public const string MongodbLsid = "db.mongodb.lsid";
    ...
    /// </remarks>
    public const string MongodbServerConnectionId = "db.mongodb.server_connection_id";
    ...
    /// </remarks>
    public const string MongodbTxnNumber = "db.mongodb.txn_number";
    ...
    /// </remarks>
    public const string NpgsqlConnectionId = "db.npgsql.connection_id";
    ...
    /// </remarks>
    public const string NpgsqlDataSource = "db.npgsql.data_source";
    ...
    /// </remarks>
    public const string NpgsqlPrepared = "db.npgsql.prepared";
    ...
    /// </remarks>
    public const string NpgsqlRows = "db.npgsql.rows";
    ...
    /// </remarks>
    public const string OdpConnectionId = "db.odp.connection.id";
    ...
    /// Span tag on the "Oracle.ManagedDataAccess.Core" ActivitySource. ODP.NET ships no public source, so the finding is the vendor's own attribute table in Oracle's ODP.NET OpenTelemetry documentation, https://docs.oracle.com/en/database/oracle/oracle-database/23/odpnt/featOpenTelemetry.html; the brief is that table's wording and the type follows the fact it describes.
    /// </remarks>
    public const string OdpRoundtripCount = "db.odp.roundtrip.count";
    ...
    /// Span tag on the "Oracle.ManagedDataAccess.Core" ActivitySource. ODP.NET ships no public source, so the finding is the vendor's own attribute table in Oracle's ODP.NET OpenTelemetry documentation, https://docs.oracle.com/en/database/oracle/oracle-database/23/odpnt/featOpenTelemetry.html; the brief is that table's wording and the type follows the fact it describes.
    /// </remarks>
    public const string OdpRoundtripDuration = "db.odp.roundtrip.duration";
    ...
    /// Span tag on the "Oracle.ManagedDataAccess.Core" ActivitySource. ODP.NET ships no public source, so the finding is the vendor's own attribute table in Oracle's ODP.NET OpenTelemetry documentation, https://docs.oracle.com/en/database/oracle/oracle-database/23/odpnt/featOpenTelemetry.html; the brief is that table's wording and the type follows the fact it describes.
    /// </remarks>
    public const string OdpRowsAffected = "db.odp.rows_affected";
    ...
    /// Span tag on the "Oracle.ManagedDataAccess.Core" ActivitySource. ODP.NET ships no public source, so the finding is the vendor's own attribute table in Oracle's ODP.NET OpenTelemetry documentation, https://docs.oracle.com/en/database/oracle/oracle-database/23/odpnt/featOpenTelemetry.html; the brief is that table's wording and the type follows the fact it describes.
    /// </remarks>
    public const string OdpSqlId = "db.odp.sql_id";
    ...
    /// Span tag on the "Oracle.ManagedDataAccess.Core" ActivitySource. ODP.NET ships no public source, so the finding is the vendor's own attribute table in Oracle's ODP.NET OpenTelemetry documentation, https://docs.oracle.com/en/database/oracle/oracle-database/23/odpnt/featOpenTelemetry.html; the brief is that table's wording and the type follows the fact it describes.
    /// </remarks>
    public const string OdpUserStatement = "db.odp.user.statement";
    ...
    /// </remarks>
    public const string OperationSummary = "db.operation.summary";
