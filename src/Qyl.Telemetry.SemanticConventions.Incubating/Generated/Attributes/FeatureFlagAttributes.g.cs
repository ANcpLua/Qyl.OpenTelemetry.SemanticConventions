...
namespace Qyl.Telemetry.SemanticConventions.Incubating.Attributes.FeatureFlag;
...
public static class FeatureFlagAttributes
{
    ...
    public static class EvaluationReasonValues
    {
        ...
        public static global::System.Collections.Generic.IReadOnlyList<string> AllValues { get; } = new[] { "cached", "default", "disabled", "error", "split", "stale", "static", "targeting_match", "unknown" };
