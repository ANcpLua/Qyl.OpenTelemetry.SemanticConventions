...
The registry is the merged core + genai + qyl projection written by generate.sh, so the
qyl-owned attributes, metrics, scope names and event names arrive through it; this
script has no second input."""
