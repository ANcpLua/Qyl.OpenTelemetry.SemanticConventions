...
Stable OpenTelemetry attribute-key constants for .NET, generated by Weaver from the upstream semantic-conventions registry.

Compatible with: OpenTelemetry Semantic Conventions v1.43.0
Targets: `net10.0`, `netstandard2.0`

Keys outside the stable surface live in the `.Incubating` sibling package. Both packages ship the embedded resolved schema for downstream tooling.
