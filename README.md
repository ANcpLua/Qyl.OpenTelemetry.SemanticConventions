...
| stable | [`Qyl.OpenTelemetry.SemanticConventions.SourceGeneration`](https://www.nuget.org/packages/Qyl.OpenTelemetry.SemanticConventions.SourceGeneration/) | Roslyn incremental source generator. Emits typed `Activity`, `Event`, `Meter`, metric, and attribute projections from the embedded resolved registry, driven by `[SemanticConvention*]` marker attributes at consumer build time. |
